...
import { OpenWeatherAirQualityConfig } from '../../pages/dashboard/air-quality/models/open-weather-air-quality-config'
import { HardwareMonitorConfig } from '../../pages/dashboard/hardware-monitor/models/hardware-monitor-config'
import { IndoorWeatherStationConfig } from '../../pages/dashboard/indoor-conditions/models/indoor-weather-station-config'
import { OpenWeatherForecastConfig } from '../../pages/dashboard/weather/models/open-weather-forecast-config'
